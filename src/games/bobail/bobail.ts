...
import { MoveResult, GameDefinitionInput, MoveControl as MoveControlTemplate} from '../../layout/grid-based-board/control';
import { RowCol, PiecePosition, samePiecePosition } from '../../layout/grid-based-board/piece-position';
import { GridGameState } from '../../layout/grid-based-board/make-basic-grid-game';
import { makeAppGridGame } from '../../layout/grid-based-board/make-app-grid-game';
import { BoardStyle } from '../../layout/grid-based-board/control/definition/game-definition';

type BobailState = {moveBobailNext: boolean};
type GameState = GridGameState<BobailState>;
...
const gamesInput: Array<GameDefinitionInput<BobailState>> = [
    {
        displayName: 'Bobail',
...
const appGames = gamesInput.map(input => makeAppGridGame(input, boardStyle, renderPiece));
