...
export type { ExtendedLetter as CoreTile } from "../../../game-controlX/games/scrabble/config/extended-letter";
export { tileScore } from "../../../game-controlX/games/scrabble/config/extended-letter";
