...
function Ticks(props: { localCount?: number }) {
...
function BoardCurrentPlayer(): JSX.Element {
  ...
  return (
    <div>
      ...
      <button onClick={() => moves.throwError('Testing')}> Throw error</button>
    </div>
  );
}
...
function Board(): JSX.Element {
  ...
  return <OuterDiv>{playerID === currentPlayer ? <BoardCurrentPlayer /> : <Ticks />}</OuterDiv>;
}
