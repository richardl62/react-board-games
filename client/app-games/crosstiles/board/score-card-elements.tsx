...
import {
  optionalScoreBackgroundColor,
  scoreCardBackgroundColor,
  scoreCardBoarderColor,
  scoreCardHeaderTextColor,
} from './style';
...
function oSBackgroundColor(self: boolean) {
  return self ? optionalScoreBackgroundColor.self : optionalScoreBackgroundColor.other;
}
