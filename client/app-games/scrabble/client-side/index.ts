...
export type { ExtendedLetter as CoreTile } from '@game-control/games/scrabble/config/extended-letter';
export { tileScore } from '@game-control/games/scrabble/config/extended-letter';
