...
export function SharedPile(props: { pile: SharedPileClass; pileIndex: number }): JSX.Element {
  ...
  return (
    <div>
      <CardStack cards={displayCards} dropID={{ area: 'sharedPiles', index: pileIndex }} />
