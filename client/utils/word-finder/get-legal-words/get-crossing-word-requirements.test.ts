...
test('crossing word requirements 1', () => {
  ...
  const letters = ['a', 'b', null, null];
  const expectedResult = [g('a'), g('b'), a('cd'), null];
...
test('crossing word requirements 2', () => {
  ...
  const letters = [null, null, 'b', 'c'];
  const expectedResult = [null, a('ax'), g('b'), g('c')];
...
test('crossing word requirements 3', () => {
  const words = ['abc'];
  const letters = ['a', 'b', null, null, 'a', null, 'c', null, null, null, 'b', 'c', null];
